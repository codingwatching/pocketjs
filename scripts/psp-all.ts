...
if (import.meta.main) {
  if (Bun.argv.includes("--help") || Bun.argv.includes("-h")) {
    console.log("Usage: bun scripts/psp-all.ts [--engine=react|vue|solid] [--debug]\n");
    ...
    console.log("Defaults to React + --release; pass --engine=vue or --engine=solid and --debug for unstripped debug builds.");
    process.exit(0);
  }

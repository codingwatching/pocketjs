//! pocketjs-framework-wasm — extern "C" mirror of the core op surface + software
...
use pocketjs_framework_core::spec::{SCREEN_H, SCREEN_W};
use pocketjs_framework_core::Ui;
...
pub extern "C" fn ui_render() -> *const u8 {
    ...
    let dl: *const pocketjs_framework_core::DrawList = u.draw();

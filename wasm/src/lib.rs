...
//! triangles, glyphs, textures); `ui_render()` keeps the byte-exact legacy
//! 480x272 path while `ui_render_scaled(scale)` rasterizes the same logical
//! DrawList directly onto an integer-scaled physical surface.
//!

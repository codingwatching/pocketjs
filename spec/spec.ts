// pocketjs-framework spec — THE single source of truth for every cross-language constant.
//
...
// ---------------------------------------------------------------------------
// pocketjs-framework packs (styles.bin, font atlases, images) reuse the dreamcart .dcpak

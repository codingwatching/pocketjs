/* cine/runtime/obj.c — scene sprites, the var-bound digit counter HUD, and the
 * blinking A prompt. Everything draws into oam_shadow; the VBlank ISR DMAs it. */
#include "cine.h"

#define OBJ_UI_BASE 1000
#define UI_TILE_PROMPT (OBJ_UI_BASE)
#define UI_TILE_DIGIT(d) (OBJ_UI_BASE + 4 + (d) * 2)

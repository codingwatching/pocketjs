...
```
spec/cine.ts        the binary contract: cue ops, tween targets, VRAM plan,
                    debug block (mirrored to runtime/cine_gen.h by spec/gen-c.ts)

/* edge/runtime/gba.h — GBA hardware definitions for the edge runtime.
...
#define DMA_START_SPECIAL 0x30000000

/* --- DirectSound A (FIFO) + Timer 0: PCM music streaming --------------------------------- */
#define REG_FIFO_A (*(vu32 *)(MEM_IO + 0x00a0))
#define REG_DMA1SAD (*(vu32 *)(MEM_IO + 0x00bc))
#define REG_DMA1DAD (*(vu32 *)(MEM_IO + 0x00c0))
#define REG_DMA1CNT (*(vu32 *)(MEM_IO + 0x00c4))
#define REG_TM0CNT_L (*(vu16 *)(MEM_IO + 0x0100))
#define REG_TM0CNT_H (*(vu16 *)(MEM_IO + 0x0102))
#define TM_ENABLE 0x0080
/* SOUNDCNT_H: PSG 100% | DSA vol 100% | DSA L+R | DSA timer 0 */
#define SND_DSA_ON 0x0306
#define SND_DSA_RESET 0x0800
